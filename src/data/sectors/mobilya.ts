...
export const mobilyaData: SectorData = {
  ...
  useCases: [
    // USE CASE 1: Yatak Odası Takımı Taksit Alacakları
    {
      ...
      financialImpact: (() => {
        const calc = calculateFullFinancing(36_000_000, 90, FINANCIAL_DATA.rates.factoring.discountRate.value, 30_000_000, 3)
    ...
    // USE CASE 2: Ofis Mobilyası B2B Satış
    {
      ...
      financialImpact: (() => {
        const calc = calculateFullFinancing(20_000_000, 120, FINANCIAL_DATA.rates.factoring.discountRate.value, 15_000_000, 4)
